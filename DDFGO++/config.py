...
# In near-perfect/no-noise runs (1e-4 for example), use simulator-provided target kinematics for map
# propagation instead of differentiating sparse/optimized map points. Set to None
# to disable this oracle override; raise the threshold to apply it to noisier runs.
